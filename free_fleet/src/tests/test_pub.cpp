...
int main(int argc, char** argv)
{
  ...
  free_fleet::dds::DDSPublishHandler<FreeFleetData_Location> pub(
      participant,
  ...
  FreeFleetData_Location* msg = FreeFleetData_Location__alloc();
  ...
  FreeFleetData_Location_free(msg, DDS_FREE_ALL);
