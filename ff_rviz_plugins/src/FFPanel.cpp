...
void FFPanel::create_robot_group_box()
{
...
void FFPanel::create_nav_group_box()
{
...
void FFPanel::create_debug_group_box()
{
...
void FFPanel::update_states(
    const ff_rviz_plugins_msgs::RobotState::ConstPtr& msg)
{
  std::unique_lock<std::mutex> robot_states_lock(_robot_states_mutex);
  _robot_states[msg->name] = *(msg.get());
